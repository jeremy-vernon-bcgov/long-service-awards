...
<div class="container">
        <div class="row d-block">
                <p class="display-4">The Province of British Columbia is pleased to invite</p>
                <p>{{$recipient->first_name . ' ' . $recipient->last_name}}</p>
                <p>to the Long Service Awards Ceremony on </p>
                <p>{{ date_format($scheduled_datetime, 'l, F j') }}
        ...
        <form method="post" action="{{url('/rsvp')}}">
            ...
            <div class="isAttending collapse">
                ...
                <div class="row d-block">
                    ...
                    <p>If you'd like a preview of accessible facilities at Government House including ramps, elevators and
                        washroom facilities, visit the <a href="https://longserviceawards.gww.gov.bc.ca/ceremony/%5d"
                                                          target="_blank">Ceremony page</a>.</p>
            ...
            <div class="notRetiring collapse">
                <div class="row d-block notRetiring">
